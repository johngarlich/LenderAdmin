...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "LenderAdmin.Application": [],
  "LenderAdmin.controller.Base": [],
  "LenderAdmin.controller.Main": [],
  "LenderAdmin.controller.MongoCalls": [],
  "LenderAdmin.model.DealerId": [],
  "LenderAdmin.model.Form": [],
  "LenderAdmin.model.FormRequirement": [],
  "LenderAdmin.model.FormType": [],
  "LenderAdmin.model.Lender": [],
  "LenderAdmin.model.LenderDealer": [],
  "LenderAdmin.model.MongoId": [],
  "LenderAdmin.store.DealerIds": [],
  "LenderAdmin.store.DealerIdsGrid": [],
  "LenderAdmin.store.DealersWithLender": [],
  "LenderAdmin.store.FormRequirements": [],
  "LenderAdmin.store.FormTypes": [],
  "LenderAdmin.store.Forms": [],
  "LenderAdmin.store.Lenders": [],
  "LenderAdmin.store.MongoIds": [],
  "LenderAdmin.view.Main": [],
  "LenderAdmin.view.MyViewport": [],
  "LenderAdmin.view.Viewport": []
});
